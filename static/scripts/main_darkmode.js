...
function image_left(img_post_id) {
    ...
    if (current_div_id != start_images) {
        ...
        document.getElementById("post_image_" + img_post_id + "_" + current_div_id).className = "post-image-hidden";
        ...
        document.getElementById("post_image_" + img_post_id + "_" + change_to).className = "post-image";
